...
class ReviewController extends Controller
{
    ...
    public function add_review(Request $request)
    {
        ...
        if($product){
            ...
            if($new_review){
                return redirect('category/'.$category_slug.'/'.$prod_slug)->with('status',"Thank You for review the product");                                
            }                                   
        }
        else{
            return redirect()->back()->with('status',"The link you followed was broken");
    ...
    public function update_review(Request $request)
    {
        ...
        if($user_review != ""){
            ...
            if($review){
                ...
                $review->update();
                return redirect('category/'.$review->product->category->slug.'/'.$review->product->slug)->with('status',"Your review for product Updated Successfully");                                
            }
            else{
                return redirect()->back()->with('status',"The link you followed was broken");
            } 
