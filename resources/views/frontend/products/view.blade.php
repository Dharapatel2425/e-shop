    ...
    <div class="product_data">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                @php $ratenum = number_format($rating_val) @endphp
                <div class="rating">
                    @for($i = 1; $i <= $ratenum ; $i++)
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-10 mb-3">
                        <br/>
                        @if($products->qty > 0)   
                            <button type="button" class="btn btn-primary me-3 addtocart float-start">Add to Cart <i class="fa fa-shopping-cart" aria-hidden="true"></i></button>                     
                        @endif
                        <button type="button" class="btn btn-success me-3 addtowishlist  float-start">Add to Wishlist <i class="fa fa-heart" aria-hidden="true"></i></button>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <a href="{{url('add-review/'.$products->slug.'/userreview')}}" class="btn btn-link review">
                        Write a Review
                    </a>
                </div>
                <div class="col-md-8">
                    ...
                    <div class="user-review">
                        ...
                        @if($item->user_id == Auth::id())
                            <a href="{{url('edit-review/'.$products->slug.'/userreview')}}" class="review ms-2">Edit</a>
                        @endif
                        <br>
                        @php
